...
public class ChessArenaPgnProcessor implements PgnProcessor {

    public static final String WORLDCHESS_COM = "worldchess.com";
    ...
    public Game parsePgn(String fullPgn) {
        ...
        for(String move : allMoves) {
            ...
            for (String m : moves) {
                String moveWithTimeRegEx = "([A-Za-z0-9\\-\\+=]+).*\\{ \\[%clk ([0-9]{2}:[0-9]{2}:[0-9]{2})] }.*";
    ...
    public boolean supports(String fullPgn) {
        return matchSite(fullPgn, WORLDCHESS_COM);
    }
}